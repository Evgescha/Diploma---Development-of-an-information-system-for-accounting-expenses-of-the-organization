...
@RequestMapping(ExpenseCategoryController.CURRENT_ADDRESS)
public class ExpenseCategoryController {
    public static final String API_PATH = "expensecategory";
    ...
    public String editPage(Model model, @PathVariable(name = "id", required = false) Long id) {
        if (id == null) {
            model.addAttribute("entity", new ExpenseCategory());
        } else {
            model.addAttribute("entity", service.read(id));
        }
    ...
    @PostMapping
    public String save(@ModelAttribute ExpenseCategory entity, RedirectAttributes ra) {
